...
import com.blog.controller.services.CatagoryServiceImpl;
...
public class CatagoryController {
	...
	@Autowired
	private CatagoryServiceImpl service;
	...
	public ResponseEntity<ApiResponse> deletingCat(@PathVariable int id)
	{
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("Catagory with Id "+id+" Deleted Successfully", true),HttpStatus.ACCEPTED);
	}
